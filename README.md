...
Datos de prueba para poder visualizar las tareas personalizadas

correo: EmilioGuzman222@gmail.com
...
En bash ingrese el siguiente comando del link que se le compartio, ejemplo: "git clone https://github.com/usuario/nombre-del-repositorio.git"
